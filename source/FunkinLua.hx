...
class FunkinLua {
	...
	public function new(script:String) {
		...
		set('playerBarColor', ClientPrefs.playerBarColor);
		set('smoothHP', ClientPrefs.smoothHP);
		set('ratingCamType', ClientPrefs.ratingCamType);
		set('comboOffset', ClientPrefs.comboOffset);
		set('ratingOffset', ClientPrefs.ratingOffset);
		set('newaccuracy', ClientPrefs.newaccuracy);
