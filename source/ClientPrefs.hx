...
class ClientPrefs {
	...
	public static var scoreType:String = 'Default';
	public static var countJudgements:Bool = false;
	public static var timeBarStyle:String = 'Default';
	public static var playerBarColor:Bool = false;
	public static var smoothHP:Bool = false;
	...
	public static var ratingCamType:String = 'camGame';
	...
	public static function saveSettings() {
		...
		FlxG.save.data.countJudgements = countJudgements;
		FlxG.save.data.lowQuality = lowQuality;
		FlxG.save.data.panIntensity = panIntensity;
		FlxG.save.data.shaders = shaders;
		FlxG.save.data.framerate = framerate;
		FlxG.save.data.longhealthbar = longhealthbar;
		FlxG.save.data.ratingCamType = ratingCamType;
		FlxG.save.data.playerBarColor = playerBarColor;
		FlxG.save.data.smoothHP = smoothHP;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.countJudgements != null) {
			countJudgements = FlxG.save.data.countJudgements;
		}
		...
		if(FlxG.save.data.ratingCamType != null) {
			ratingCamType = FlxG.save.data.ratingCamType;
		}
		...
		if(FlxG.save.data.playerBarColor != null) {
			playerBarColor = FlxG.save.data.playerBarColor;
		}
		...
		if(FlxG.save.data.smoothHP != null) {
			smoothHP = FlxG.save.data.smoothHP;
		}
