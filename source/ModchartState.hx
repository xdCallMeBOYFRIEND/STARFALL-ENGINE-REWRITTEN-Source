...
class ModchartState 
{
	...
	{	
		...
		PlayState.instance.healthBar.reloadHealthBarColors();
		...
		if (ClientPrefs.playerBarColor) {
			PlayState.scoreTxt.color = FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]);
			PlayState.botplayTxt.color = FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]);
		}
	}
    ...
    public function new(path:String, ?preloading:Bool = false, ?isStageLua:Bool = false)
    {
		...
		else
		{
			...
			Lua_helper.add_callback(lua,"updateHealthbar", function(dadColor:String = "", bfColor:String = ""){
				...
				if (dadColor == "")
					opponent = PlayState.instance.dad.healthColorArray;
				else
					opponent = dadColor;
	
				if (bfColor == "")
					player = PlayState.instance.boyfriend.healthColorArray;
				else
					player = bfColor;
